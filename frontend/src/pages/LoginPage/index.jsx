      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Manage SOCIO.LK's sales, inventory and customers all in one place with{" "}
        ...
        {/* RIGHT — WHITE PANEL */}
        <div
          className="w-full md:w-[45%] flex flex-col justify-between p-9"
        ...
        >
          ...
          <p className="text-center text-xs" style={{ color: "#94a3b8" }}>
            © 2026 SOCIO.LK  All rights reserved.
          </p>
        </div>
      </div>
    </div>
